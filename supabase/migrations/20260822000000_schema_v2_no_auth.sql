-- Fase A: sustituye el esquema multi-tenant con login (20260821120000) por el
...
drop table if exists pull_llm_analysis cascade;
drop table if exists baseline_pulls cascade;
drop table if exists pull_diffs cascade;
drop table if exists pull_player_stats cascade;
drop table if exists pull_deaths cascade;
drop table if exists pull_mechanic_instances cascade;
drop table if exists raid_nights cascade;
drop table if exists cooldown_catalog cascade;
drop table if exists encounter_mechanics cascade;
drop table if exists encounters cascade;
drop table if exists raiders cascade;
drop table if exists raid_teams cascade;

drop table if exists player_pull_records cascade;
drop table if exists pull_briefs cascade;
drop table if exists llm_calls cascade;
drop table if exists session_state cascade;
drop table if exists pulls cascade;
drop table if exists report_encounters cascade;
drop table if exists reports cascade;
drop table if exists boss_mechanics_candidates cascade;
drop table if exists boss_mechanics cascade;

-- ============ ESQUEMA NUEVO (sin login, mecánicas auto-descubiertas) ============
...
-- Fila singleton obligatoria para session_state (id boolean primary key default true).
